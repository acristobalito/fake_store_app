...
class SignUpScreenProvider extends ChangeNotifier {
  ...
  SignUpScreenProvider({required this.productsRepository}) {
    registerUserUseCase = RegisterUserUseCase(productsRepository);
  }
  ...
  void registerUser(UserParamsModel user,
    ...
    final params = UserModel(
        ...
        phone: user.phone);
    final request = await registerUserUseCase.invoke(params);
    request != null
        ? onSuccess.call()
